...
namespace Marqdouj.DotNet.AzureMaps
{
    public static class Extensions
    {
        ...
        /// </summary>
        /// <remarks>If <paramref name="validate"/> is set to <see langword="true"/>, the
        ...
        /// <param name="validate">Specifies whether to enable validation of the <see cref="MapConfiguration"/> during configuration. Set to
